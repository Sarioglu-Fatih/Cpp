...
/*   Updated: 2023/06/22 14:37:31 by fsariogl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Inherit ScavTrap default constructor called." << std::endl;
}

ScavTrap::~ScavTrap()
{
	std::cout << "Inherit ScavTrap desctructor called." << std::endl;
	return ;
}
...
ScavTrap::ScavTrap(const ScavTrap &scav)
{
	...
	std::cout << "Inherit ScavTrap copy constructor called." << std::endl;
}

ScavTrap::ScavTrap(std::string str) : ClapTrap(str, 100, 50, 20)
{
	std::cout << "Inherit ScavTrap constructor called." << std::endl;
}
...
ScavTrap	&ScavTrap::operator=(const ScavTrap &scav)
{
	...
	this->attackDamage = scav.attackDamage;
	std::cout << "Inherit ScavTrap copy assignement operator called." << std::endl;
	return (*this);
}
