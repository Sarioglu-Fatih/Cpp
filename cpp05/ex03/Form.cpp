...
/*   Updated: 2023/07/26 12:04:33 by fsariogl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Form::setForm(std::string n, bool b, int sg, int eg)
{
	(std::string &)this->name = n;
	this->sign = b;
	(int &)this->signGrade = sg;
	(int &)this->executeGrade = eg;
}
